...
internal static unsafe class SdlNative
{
    ...
    [StructLayout(LayoutKind.Sequential)] internal unsafe struct TextInputEvent { internal uint Type; internal uint Reserved; internal ulong Timestamp; internal uint WindowId; internal IntPtr Text; }
    ...
    [return: MarshalAs(UnmanagedType.I1)][DllImport(Library, CallingConvention = CallingConvention.Cdecl)] internal static extern bool SDL_SetWindowSize(IntPtr window, int width, int height);
