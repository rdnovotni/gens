...
public sealed record RosterRowModel(string CharacterId, string Name, string Subtitle, string Monogram);
...
public sealed record CharacterDetailModel(
    string CharacterId, string Name, string Subtitle, string Monogram,
